...
class AsyncTestsNonIso(ConnectingTestCase):
    default_datestyle = os.environ.get("PGDATESTYLE", "iso, dmy")
    
    def setUp(self):
        os.environ["PGDATESTYLE"] = "sql, mdy"
    ...
    def tearDownClass(cls):
        os.environ["PGDATESTYLE"] = AsyncTestsNonIso.default_datestyle
